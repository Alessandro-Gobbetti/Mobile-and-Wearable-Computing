...
public class StepCounterListener implements SensorEventListener {
    ...
    //TODO 17 (Your Turn): Add the CircularProgressIndicator as a parameter in the constructor
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        switch (sensorEvent.sensor.getType())
        {
            case Sensor.TYPE_LINEAR_ACCELERATION:
                ...
                // Log the sensor data every second
            ...
            case Sensor.TYPE_STEP_DETECTOR:
                ...
                Log.d("STEP DETECTOR", "Step detected:" + sensorEvent.values[0]);
                break;
        }
    }
    @Override
    ...
    private void peakDetection() {
        ...
        for (int i = 1; i < valuesInWindow.size()-1; i++) {
            // compare current value with the previous and next
            ...
            // if current value is peak and above the threshold
